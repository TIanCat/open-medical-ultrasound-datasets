...
| [0015](datasets/00_breast/0015.yaml) | BUS-UCLM | Breast | 2D ultrasound PNG; some Doppler | 683 image/mask pairs / 38 patients (419 normal, 174 benign, 90 malignant) | three-class classification; lesion segmentation/detection | 🟢 Open; CC BY 4.0 | [Vallez et al., 2025](https://doi.org/10.1038/s41597-025-04562-3) | [Mendeley Data v3](https://data.mendeley.com/datasets/7fvgj4jsp7/3) |
| [0016](datasets/00_breast/0016.yaml) | TDSC-ABUS2023 | Breast | 3D ABUS NRRD volumes | 200 cases: 100 train / 30 validation / 70 test | 3D detection; segmentation; binary classification | 🟡 Signed agreement; no redistribution | [Luo et al., 2025](https://doi.org/10.48550/arXiv.2501.15588) | [Grand Challenge](https://tdsc-abus2023.grand-challenge.org/Dataset/) |
