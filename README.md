...
| [0003](datasets/00_breast/0003.yaml) | Medical Image Database (MID) | Breast | 2D B-mode | 180 test images / 180 patients (+15 tuning images) | segmentation; classification | 🟢 Open | [Rodtook et al., 2018](https://doi.org/10.1016/j.patcog.2018.01.032) | [Online Medical Images](https://www.onlinemedicalimages.com/index.php/en/site-map) |
...
| [0006](datasets/00_breast/0006.yaml) | BreastVid | Breast | 2D B-mode cine / image sequences | 188 videos / 25,272 frames (paper-reported; see correction) | detection; classification | 🟢 Open | [Lin et al., 2022](https://doi.org/10.1007/978-3-031-16437-8_59) | [CVA-Net repository](https://github.com/jhl-Det/CVA-Net) |
