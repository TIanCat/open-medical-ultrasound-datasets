...
| [0104](datasets/01_thyroid/0104.yaml) | TG3K | Thyroid | 2D B-mode | ~3,583–3,585 frames | segmentation | 🟢 Open | [Gong et al., 2022](https://doi.org/10.1016/j.compbiomed.2022.106389) | [GitHub](https://github.com/haifangong/TRFE-Net-for-thyroid-nodule-segmentation) |
| [0105](datasets/01_thyroid/0105.yaml) | TN3K | Thyroid | 2D B-mode | 3,493 images / 2,421 patients | segmentation | 🟢 Open | [Gong et al., 2022](https://doi.org/10.1016/j.compbiomed.2022.106389) | [GitHub](https://github.com/haifangong/TRFE-Net-for-thyroid-nodule-segmentation) |
| [0106](datasets/01_thyroid/0106.yaml) | SegThy | Thyroid | Tracked 3D B-mode + MRI subset | 214 participants | segmentation; measurement | 🟢 Open | [Krönke et al., 2022](https://doi.org/10.1371/journal.pone.0268550) | [TUM](https://www.cs.cit.tum.de/en/camp/publications/segthy-dataset/) |
| [0107](datasets/01_thyroid/0107.yaml) | Thyroid Ultrasound Cine-clip | Thyroid | 2D B-mode cine | 192 videos / 17,412 frames / 167 patients | segmentation; classification; grading | 🟡 Application | [ Yamashita et al., 2022](https://doi.org/10.1148/ryai.210174) | [ Stanford AIMI](https://aimi.stanford.edu/datasets/thyroid-ultrasound-cine-clip) |
| [0108](datasets/01_thyroid/0108.yaml) | TN5000 | Thyroid | 2D B-mode | 5,000 images | detection; classification | 🟢 Open | [Zhang et al., 2025](https://doi.org/10.1038/s41597-025-05757-4) | [Figshare](https://springernature.figshare.com/articles/dataset/TN5000_An_Ultrasound_Image_Dataset_for_Thyroid_Nodule_Detection_and_Classification/28455641) |

### Obstetrics
| ID | Dataset | Anatomy | Modality | Size | Task | Access | Paper | Data |
|---|---|---|---|---|---|---|---|---|
| [0201](datasets/02_obstetrics/0201.yaml) | HC18 | Fetus / fetal head | 2D B-mode | 1,334 images / 551 patients | segmentation; measurement | 🟢 Open | [van den Heuvel et al., 2018](https://doi.org/10.1371/journal.pone.0200412) | [Zenodo](https://doi.org/10.5281/zenodo.1322000) |
| [0202](datasets/02_obstetrics/0202.yaml) | FETAL_PLANES_DB | Fetus + maternal cervix | 2D B-mode  | 12,400 images / 1,792 patients | classification | 🟢 Open | [Burgos-Artizzu et al., 2020](https://doi.org/10.1038/s41598-020-67076-5) | [Zenodo](https://doi.org/10.5281/zenodo.3904280) |
| [0203](datasets/02_obstetrics/0203.yaml) | JNU-IFM | Maternal pelvis + fetal head | 2D transperineal B-mode image sequences | 78 videos / 6,224 frames / 51 patients | classification; segmentation | 🟢 Open | [Lu et al., 2022](https://doi.org/10.1016/j.dib.2022.107904) | [Figshare](https://doi.org/10.6084/m9.figshare.14371652) |
| [0204](datasets/02_obstetrics/0204.yaml) | African Fetal Standard Plane Dataset | Fetus | 2D B-mode | 450 images / 125 patient records | classification| 🟢 Open | [Sendra-Balcells et al., 2023](https://doi.org/10.1038/s41598-023-29490-3) | [Zenodo](https://doi.org/10.5281/zenodo.7540448) |
| [0205](datasets/02_obstetrics/0205.yaml) | FPUS23 | 23-week fetal phantom | 2D B-mode | 15,728 images | plane and orientation classification; detection | 🟢 Open | [Prabakaran et al., 2023](https://doi.org/10.1109/ACCESS.2023.3284315) | [GitHub](https://github.com/bharathprabakaran/FPUS23) |
| [0206](datasets/02_obstetrics/0206.yaml) | Fetal Abdominal Structures Segmentation Dataset | Fetus / fetal abdomen | 2D B-mode | 1,588 images / 169 patients | segmentation | 🟢 Open | -- | [Mendeley Data](https://doi.org/10.17632/4gcpm9dsc3.1) |
| [0207](datasets/02_obstetrics/0207.yaml) | ACOUSLIC-AI | Fetus / fetal abdomen | 2D blind-sweep B-mode image sequences | 300 public cases / 252,000 frames | frame localization; segmentation; measurement | 🟢 Open | [Sappia et al., 2025](https://doi.org/10.1016/j.media.2025.103640) | [Zenodo](https://doi.org/10.5281/zenodo.12697994) |
| [0208](datasets/02_obstetrics/0208.yaml) | PSFHS | Maternal pelvis / pubic symphysis + fetal head | 2D transperineal B-mode | 1,358 images / 1,124 patients | segmentation; measurement | 🟢 Open | [Chen et al., 2024](https://doi.org/10.1038/s41597-024-03266-4) | [Zenodo](https://doi.org/10.5281/zenodo.10969427) |
| [0209](datasets/02_obstetrics/0209.yaml) | FOCUS | Fetus / fetal heart + thorax | 2D four-chamber B-mode | 300 images / 217 patients | segmentation; detection; measurement | 🟢 Open | -- | [Zenodo](https://doi.org/10.5281/zenodo.14597550) |
| [0210](datasets/02_obstetrics/0210.yaml) | Maternal-Fetal Ultrasound Video Dataset | Maternal pelvis / pubic symphysis + fetal head | 2D transperineal B-mode video | 774 videos / 68,106 frames / 774 patients | classification; segmentation; landmark detection; measurement | 🟢 Open | [Niu et al., 2026](https://doi.org/10.1038/s41597-026-06900-5) | [Zenodo](https://doi.org/10.5281/zenodo.17655183) |
