...
| [0013](datasets/0013.yaml) | US3M | Breast | B-mode + color Doppler + elastography | 1,532 images / 248 patients (145 benign, 103 malignant) | multimodal binary classification; simulated missing-modality learning | 🟢 Non-commercial; CC BY-NC 4.0 | [Yan et al., 2024](https://doi.org/10.1016/j.inffus.2024.102592) | [Kaggle](https://www.kaggle.com/datasets/timesxy/multimodal-breast-ultrasound-dataset-us3m) |
| [0014](datasets/0014.yaml) | ALN-Ultra | Breast cancer / ALN metastasis | paired ultrasound stills + cine videos | 257 patients; exact file counts currently unverifiable | ALN metastasis prediction; image-video comparison | 🔴 Restricted files; CC BY 4.0 metadata | Dataset resource; no dedicated peer-reviewed paper identified | [Zenodo replacement record](https://zenodo.org/records/18483501) |
| [0015](datasets/0015.yaml) | BUS-UCLM | Breast | 2D ultrasound PNG; some Doppler | 683 image/mask pairs / 38 patients (419 normal, 174 benign, 90 malignant) | three-class classification; lesion segmentation/detection | 🟢 Open; CC BY 4.0 | [Vallez et al., 2025](https://doi.org/10.1038/s41597-025-04562-3) | [Mendeley Data v3](https://data.mendeley.com/datasets/7fvgj4jsp7/3) |
| [0016](datasets/0016.yaml) | TDSC-ABUS2023 | Breast | 3D ABUS NRRD volumes | 200 cases: 100 train / 30 validation / 70 test | 3D detection; segmentation; binary classification | 🟡 Signed agreement; no redistribution | [Luo et al., 2025](https://doi.org/10.48550/arXiv.2501.15588) | [Grand Challenge](https://tdsc-abus2023.grand-challenge.org/Dataset/) |
