...
| [1904](datasets/19_multi‑anatomy/1904.yaml) | Multi-Anatomical Ultrafast Ultrasound Dataset | Abdomen; arm; back; breast; carotid/neck; leg; phantom | Ultrafast plane-wave raw RF channel data | 20,431 acquisitions: 20,121 in vivo / 16 volunteers + 310 phantom | beamforming/reconstruction; sparse-array RF inpainting | 🟢 Open; CC BY 4.0 | [Paper](https://doi.org/10.1109/TCI.2025.3648531) | [Zenodo](https://zenodo.org/records/22125184) |
| [1905](datasets/19_multi‑anatomy/1905.yaml) | US simulation & segmentation / AbdomenUS | Multi-organ abdomen | 617 real + 926 simulated 2D ultrasound images | 1,543 images; real data from 11 healthy subjects | organ/structure segmentation; simulation; domain adaptation | 🟡 Public Kaggle download; reuse license not stated | [Paper](https://doi.org/10.1007/s11548-019-02046-5) | [Kaggle](https://www.kaggle.com/datasets/ignaciorlando/ussimandsegm) |
...
| [2009](datasets/20_other/2009.yaml) | Prostate-MRI-US-Biopsy | Prostate | 3D TRUS + T2/ADC/high-b-value MRI | 1,151 subjects / 1,762 US + 3,057 MR series | registration; prostate/ROI segmentation; tracked-biopsy/pathology analysis | 🟢 Open; CC BY 4.0 | [Authors' reference](https://doi.org/10.1016/j.juro.2012.08.095) | [TCIA](https://doi.org/10.7937/TCIA.2020.A61IOC1A) |
| [2010](datasets/20_other/2010.yaml) | μ-RegPro | Prostate | Paired 3D T2-weighted MRI + reconstructed transperineal TRUS | 108 patients/pairs: 65 train, 8 validation, 35 holdout | MRI-to-TRUS registration; prostate/landmark alignment | 🟡 Public download; research-only/non-commercial | [Dataset record](https://doi.org/10.5281/zenodo.7870104) | [μ-RegPro](https://muregpro.github.io/data.html) |
| [2011](datasets/20_other/2011.yaml) | Micro-Ultrasound Prostate Segmentation Dataset | Prostate | 29-MHz transrectal micro-US 3D NIfTI volumes | 75 patients/volumes: 55 train, 20 test | prostate segmentation; annotation-guided learning; inter-annotator comparison | 🟢 Open; CC BY 4.0 | [Paper](https://doi.org/10.1016/j.compmedimag.2024.102326) | [Zenodo](https://doi.org/10.5281/zenodo.10475293) |
...
| [2016](datasets/20_other/2016.yaml) | MMOTU | Ovary / ovarian tumor | 2D ultrasound + CEUS images; no 3D volumes | 1,639 images / 294 patients: 1,469 OTU_2d + 170 OTU_CEUS | lesion segmentation; category classification; cross-domain segmentation | 🟡 Public download; dataset license not separately stated | [Paper](https://doi.org/10.1016/j.patcog.2025.112311) | [GitHub](https://github.com/cv516Buaa/MMOTU_DS2Net) |
| [2017](datasets/20_other/2017.yaml) | PCOSGen | Ovary | 2D ultrasound video frames released as RGB JPEG | 4,668 images: 3,200 train + 1,468 test | normal/abnormal and PCOS-evidence-visibility classification | 🟡 Open; CC BY 4.0, with academic/research-use note | [Challenge document](https://zenodo.org/records/10430727/files/Meta_Data.pdf) | [Train](https://zenodo.org/records/14592001) / [Test](https://zenodo.org/records/14591782) |
